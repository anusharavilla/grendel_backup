...
$netlist = "./${SYNTH_DIR}/run_f/Top_netlist.v";
...
$topinst = "top_inst";
$MEMDIR = "./MEMORY/";
$TOPFILE = "./HDL/run_s/top_with_mem.v";
...
if ($helpplease == 1) {
	...
	print "The full path to the synthesized netlist (-net) [DEFAULT: ./SYNTH/run_f/top_netlist.v]\n";
	...
	print "The full path to the backward saif file (-saif) [DEFAULT: ./SIMULATION/run_f/top_back.saif]\n";
	...
	print "The full path to the memory + top integration (-topfile) [DEFAULT: ./HDL/run_s/top_with_mem.v]\n";
...
if ($setup_op == 1) { 
	...
	#system("cp /afs/eos.ncsu.edu/engrwww/sites/ece/asic/share/common/modelsim.ini ${SIM_DIR}/run_f/");
	#system("cp /afs/eos.ncsu.edu/engrwww/sites/ece/asic/share/common/modelsim.ini ${SIM_DIR}/run_s/");
	#system("cp /afs/eos.ncsu.edu/engrwww/sites/ece/asic/share/common/Library_fwd.saif ${SIM_DIR}/run_f/");
	#system("cp /afs/eos.ncsu.edu/engrwww/sites/ece/asic/share/Tut2/Constraints.tcl ${SYNTH_DIR}/run_f/");
...
if($memory_op == 1 ) {
	...
	read_parasitics ${WORK_DIRECTORY}/${PANDR_DIR}/run_f/$modname.spef -path ${topinst} -net_cap_only -complete_with wlm
	#report_power -hier -hier_level 3 -analysis_effort medium  > ${modname}_pwr_post_annotation.rpt
