...
/** \file
 * Class definition for protocol Cortex__AMBAPVACE.
 */

#ifndef Cortex__AMBAPVACE_ClassDef_h_
#define Cortex__AMBAPVACE_ClassDef_h_
...
public:
    ...
    void SetPort(Cortex__AMBAPVACE *port) { thisPort = port; }
...
private:
    ...
    Cortex__AMBAPVACE *thisPort;
};


// Protocol (port) class definition
class Cortex__AMBAPVACE: public sg::Port
{
private:
...
transport_dbg.bind_default_behaviour( this, &Cortex__AMBAPVACE::default_transport_dbg);get_direct_mem_ptr.bind_default_behaviour( this, &Cortex__AMBAPVACE::default_get_direct_mem_ptr);b_snoop.bind_default_behaviour( this, &Cortex__AMBAPVACE::default_b_snoop);snoop_dbg.bind_default_behaviour( this, &Cortex__AMBAPVACE::default_snoop_dbg);invalidate_direct_mem_ptr.bind_default_behaviour( this, &Cortex__AMBAPVACE::default_invalidate_direct_mem_ptr);
    }
...
// Mapping object
// (these ports are implemented inside Cortex__AMBAPVACE__AddressablePort)
class Cortex__AMBAPVACE__AddressablePort_OutPort: public Cortex__AMBAPVACE
{
public:
    // constructor
    Cortex__AMBAPVACE__AddressablePort_OutPort(uint32_t inFirst,
                                                 uint32_t inLast,
                                                 uint32_t outFirst,
                                                 uint32_t outLast):
    inFirst__(inFirst),
...
class Cortex__AMBAPVACE__AddressablePort: public Cortex__AMBAPVACE
{
public:
    ...
    Cortex__AMBAPVACE__AddressablePort():
    defaultOutPort__(0),
    portName__("(unknown name)")
    {
        ...
        bind_method(*this, mapRange, &Cortex__AMBAPVACE__AddressablePort::mapRange__, this);
        bind_method(*this, mapDefault, &Cortex__AMBAPVACE__AddressablePort::mapDefault__, this);
        bind_method(*this, unmapRange, &Cortex__AMBAPVACE__AddressablePort::unmapRange__, this);
        bind_method(*this, isMapped, &Cortex__AMBAPVACE__AddressablePort::isMapped__, this);
    ...
    Cortex__AMBAPVACE__AddressablePort_OutPort *locateOutPort__(uint32_t &addr)
    {
        OutPortList__::iterator it;
        for (it = outPortList__.begin(); it != outPortList__.end(); ++it)
        {
    ...
    {
        Cortex__AMBAPVACE__AddressablePort_OutPort *masterPort =
            new Cortex__AMBAPVACE__AddressablePort_OutPort(inFirst, inLast, outFirst, outLast);
    ...
    {
        delete defaultOutPort__;
        defaultOutPort__ = new Cortex__AMBAPVACE__AddressablePort_OutPort(0, uint32_t(0) - 1, 0, uint32_t(0) - 1);
        return defaultOutPort__;
    }

    void unmapRange__(sg::Port* port)
    {
        outPortList__.remove((Cortex__AMBAPVACE__AddressablePort_OutPort*)port);
...
private:
    typedef std::list<Cortex__AMBAPVACE__AddressablePort_OutPort*> OutPortList__;
    OutPortList__ outPortList__;
    Cortex__AMBAPVACE__AddressablePort_OutPort *defaultOutPort__;
