 ...
 */
class scheduler_mapping: public sg::SchedulerInterfaceForComponents
{
...
private:
    ...
    static inline sc_core::sc_time simulated_time_from_ticks(sg::ticks_t ticks)
    {
#if defined(SYSTEMC_2_3_1)
        return sc_core::sc_time::from_value(ticks);
#elif defined(SYSTEMC_2_3_0)
        return sc_core::sc_time(sc_dt::uint64(ticks), false);
#else
        return sc_core::sc_time(double(ticks) * sc_core::sc_get_time_resolution().to_seconds(), sc_core::SC_SEC);
