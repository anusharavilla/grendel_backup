...
/** \file
 * Class definition for protocol Cortex__PVCacheMaintenance.
 */

#ifndef Cortex__PVCacheMaintenance_ClassDef_h_
#define Cortex__PVCacheMaintenance_ClassDef_h_
...
class Cortex__PVCacheMaintenance;
...
public:
    ...
    void SetPort(Cortex__PVCacheMaintenance *port) { thisPort = port; }
...
private:
    ...
    Cortex__PVCacheMaintenance *thisPort;
};


// Protocol (port) class definition
class Cortex__PVCacheMaintenance: public sg::Port
{
private:
...
// Mapping object
// (these ports are implemented inside Cortex__PVCacheMaintenance__AddressablePort)
class Cortex__PVCacheMaintenance__AddressablePort_OutPort: public Cortex__PVCacheMaintenance
{
public:
    // constructor
    Cortex__PVCacheMaintenance__AddressablePort_OutPort(uint32_t inFirst,
                                                 uint32_t inLast,
                                                 uint32_t outFirst,
                                                 uint32_t outLast):
    inFirst__(inFirst),
...
class Cortex__PVCacheMaintenance__AddressablePort: public Cortex__PVCacheMaintenance
{
public:
    ...
    Cortex__PVCacheMaintenance__AddressablePort():
    defaultOutPort__(0),
    portName__("(unknown name)")
    {
        ...
        bind_method(*this, mapRange, &Cortex__PVCacheMaintenance__AddressablePort::mapRange__, this);
        bind_method(*this, mapDefault, &Cortex__PVCacheMaintenance__AddressablePort::mapDefault__, this);
        bind_method(*this, unmapRange, &Cortex__PVCacheMaintenance__AddressablePort::unmapRange__, this);
        bind_method(*this, isMapped, &Cortex__PVCacheMaintenance__AddressablePort::isMapped__, this);
    ...
    Cortex__PVCacheMaintenance__AddressablePort_OutPort *locateOutPort__(uint32_t &addr)
    {
        OutPortList__::iterator it;
        for (it = outPortList__.begin(); it != outPortList__.end(); ++it)
        {
    ...
    {
        Cortex__PVCacheMaintenance__AddressablePort_OutPort *masterPort =
            new Cortex__PVCacheMaintenance__AddressablePort_OutPort(inFirst, inLast, outFirst, outLast);
    ...
    {
        delete defaultOutPort__;
        defaultOutPort__ = new Cortex__PVCacheMaintenance__AddressablePort_OutPort(0, uint32_t(0) - 1, 0, uint32_t(0) - 1);
        return defaultOutPort__;
    }

    void unmapRange__(sg::Port* port)
    {
        outPortList__.remove((Cortex__PVCacheMaintenance__AddressablePort_OutPort*)port);
...
private:
    typedef std::list<Cortex__PVCacheMaintenance__AddressablePort_OutPort*> OutPortList__;
    OutPortList__ outPortList__;
    Cortex__PVCacheMaintenance__AddressablePort_OutPort *defaultOutPort__;
