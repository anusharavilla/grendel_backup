...
/** \file
 * Class definition for protocol Cortex__CADIDisassemblerProtocol.
 */

#ifndef Cortex__CADIDisassemblerProtocol_ClassDef_h_
#define Cortex__CADIDisassemblerProtocol_ClassDef_h_
...
class Cortex__CADIDisassemblerProtocol;
...
public:
    ...
    void SetPort(Cortex__CADIDisassemblerProtocol *port) { thisPort = port; }
...
private:
    ...
    Cortex__CADIDisassemblerProtocol *thisPort;
};


// Protocol (port) class definition
class Cortex__CADIDisassemblerProtocol: public sg::Port
{
private:
...
public:
    ...
    Cortex__CADIDisassemblerProtocol()
    {
...
// Mapping object
// (these ports are implemented inside Cortex__CADIDisassemblerProtocol__AddressablePort)
class Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort: public Cortex__CADIDisassemblerProtocol
{
public:
    // constructor
    Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort(uint32_t inFirst,
                                                 uint32_t inLast,
                                                 uint32_t outFirst,
                                                 uint32_t outLast):
    inFirst__(inFirst),
...
class Cortex__CADIDisassemblerProtocol__AddressablePort: public Cortex__CADIDisassemblerProtocol
{
public:
    ...
    Cortex__CADIDisassemblerProtocol__AddressablePort():
    defaultOutPort__(0),
    portName__("(unknown name)")
    {
        ...
        bind_method(*this, mapRange, &Cortex__CADIDisassemblerProtocol__AddressablePort::mapRange__, this);
        bind_method(*this, mapDefault, &Cortex__CADIDisassemblerProtocol__AddressablePort::mapDefault__, this);
        bind_method(*this, unmapRange, &Cortex__CADIDisassemblerProtocol__AddressablePort::unmapRange__, this);
        bind_method(*this, isMapped, &Cortex__CADIDisassemblerProtocol__AddressablePort::isMapped__, this);
    ...
    Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort *locateOutPort__(uint32_t &addr)
    {
        OutPortList__::iterator it;
        for (it = outPortList__.begin(); it != outPortList__.end(); ++it)
        {
    ...
    {
        Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort *masterPort =
            new Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort(inFirst, inLast, outFirst, outLast);
    ...
    {
        delete defaultOutPort__;
        defaultOutPort__ = new Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort(0, uint32_t(0) - 1, 0, uint32_t(0) - 1);
        return defaultOutPort__;
    }

    void unmapRange__(sg::Port* port)
    {
        outPortList__.remove((Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort*)port);
...
private:
    typedef std::list<Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort*> OutPortList__;
    OutPortList__ outPortList__;
    Cortex__CADIDisassemblerProtocol__AddressablePort_OutPort *defaultOutPort__;
