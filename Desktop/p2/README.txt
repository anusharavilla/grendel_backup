...
ARM Fast Models CORTEX M0 TestBench
(c) 2012-2016 By W. Rhett Davis
...
2.0 simulations with the ARM Fast Models for the Cortex M0 processor.
...
sgc/src/             - This directory contains the SystemC TLM-2.0 files
                         to setup instance of a Cortex-M0 processor and
                         connect it to a memory through an AMBA-PV socket
                         to a TLM 2.0 socket.
sgc/Cortex-M0.lisa   - ARM System Generator Canvas system description
                         for a simple Cortex-M0 processor with a 100 MHx
                         clock and AMBA-PV transaction port.
sgc/Cortex-M0.sgproj - ARM System Generator Canvas project file corresonding
                         to the Cortex-M0.lisa file.  This was a generated
...
2) Use "source setup.csh" or "source setup.sh" to setup your environment
3) Use "make" to build the fibonacci.axf file
4) Change to the "../sgc" directory
5) Use "source setup.csh" or "source setup.sh" to setup your environment
