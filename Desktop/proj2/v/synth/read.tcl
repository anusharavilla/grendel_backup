...
read_verilog $RTL_DIR/DMA_slave.v
read_verilog $RTL_DIR/DMA_datapath.v
read_verilog $RTL_DIR/DMA_controller.v
read_verilog $RTL_DIR/arbiter.v
read_verilog $RTL_DIR/dma_unit.v
#read_verilog $RTL_DIR/integrated_cpu_dma.v
