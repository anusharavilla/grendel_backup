...
/** \file
 * Class definition for protocol Cortex__Builtin__BUSProtocol.
 */

#ifndef Cortex__Builtin__BUSProtocol_ClassDef_h_
#define Cortex__Builtin__BUSProtocol_ClassDef_h_
...
class Cortex__Builtin__BUSProtocol;
...
public:
    ...
    void SetPort(Cortex__Builtin__BUSProtocol *port) { thisPort = port; }
...
private:
    ...
    Cortex__Builtin__BUSProtocol *thisPort;
};


// Protocol (port) class definition
class Cortex__Builtin__BUSProtocol: public sg::Port
{
private:
...
// Mapping object
// (these ports are implemented inside Cortex__Builtin__BUSProtocol__AddressablePort)
class Cortex__Builtin__BUSProtocol__AddressablePort_OutPort: public Cortex__Builtin__BUSProtocol
{
public:
    // constructor
    Cortex__Builtin__BUSProtocol__AddressablePort_OutPort(MxU32 inFirst,
                                                 MxU32 inLast,
                                                 MxU32 outFirst,
                                                 MxU32 outLast):
    inFirst__(inFirst),
...
class Cortex__Builtin__BUSProtocol__AddressablePort: public Cortex__Builtin__BUSProtocol
{
public:
    ...
    Cortex__Builtin__BUSProtocol__AddressablePort():
    defaultOutPort__(0),
    portName__("(unknown name)")
    {
        ...
        bind_method(*this, mapRange, &Cortex__Builtin__BUSProtocol__AddressablePort::mapRange__, this);
        bind_method(*this, mapDefault, &Cortex__Builtin__BUSProtocol__AddressablePort::mapDefault__, this);
        bind_method(*this, unmapRange, &Cortex__Builtin__BUSProtocol__AddressablePort::unmapRange__, this);
        bind_method(*this, isMapped, &Cortex__Builtin__BUSProtocol__AddressablePort::isMapped__, this);
		bind_method(*this, read8, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__read8__, this);
		bind_method(*this, read16, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__read16__, this);
		bind_method(*this, read32, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__read32__, this);
		bind_method(*this, read64, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__read64__, this);
		bind_method(*this, read, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__read__, this);
		bind_method(*this, write8, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__write8__, this);
		bind_method(*this, write16, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__write16__, this);
		bind_method(*this, write32, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__write32__, this);
		bind_method(*this, write64, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__write64__, this);
		bind_method(*this, write, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__write__, this);
		bind_method(*this, readDbg8, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__readDbg8__, this);
		bind_method(*this, readDbg16, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__readDbg16__, this);
		bind_method(*this, readDbg32, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__readDbg32__, this);
		bind_method(*this, readDbg64, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__readDbg64__, this);
		bind_method(*this, readDbg, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__readDbg__, this);
		bind_method(*this, writeDbg8, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__writeDbg8__, this);
		bind_method(*this, writeDbg16, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__writeDbg16__, this);
		bind_method(*this, writeDbg32, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__writeDbg32__, this);
		bind_method(*this, writeDbg64, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__writeDbg64__, this);
		bind_method(*this, writeDbg, &Cortex__Builtin__BUSProtocol__AddressablePort::wrapper__writeDbg__, this);
    ...
    Cortex__Builtin__BUSProtocol__AddressablePort_OutPort *locateOutPort__(MxU32 &addr)
    {
        OutPortList__::iterator it;
        for (it = outPortList__.begin(); it != outPortList__.end(); ++it)
        {
    ...
    {
        Cortex__Builtin__BUSProtocol__AddressablePort_OutPort *masterPort =
            new Cortex__Builtin__BUSProtocol__AddressablePort_OutPort(inFirst, inLast, outFirst, outLast);
    ...
    {
        delete defaultOutPort__;
        defaultOutPort__ = new Cortex__Builtin__BUSProtocol__AddressablePort_OutPort(0, MxU32(0) - 1, 0, MxU32(0) - 1);
        return defaultOutPort__;
    }

    void unmapRange__(sg::Port* port)
    {
        outPortList__.remove((Cortex__Builtin__BUSProtocol__AddressablePort_OutPort*)port);
	...
	MxStatus wrapper__read8__(MxU32 param0__, MxU8& param1__)
	{
		...
		Cortex__Builtin__BUSProtocol__AddressablePort_OutPort *outPort = locateOutPort__(param0__);
		if (outPort == 0)
		{
...
private:
    typedef std::list<Cortex__Builtin__BUSProtocol__AddressablePort_OutPort*> OutPortList__;
    OutPortList__ outPortList__;
    Cortex__Builtin__BUSProtocol__AddressablePort_OutPort *defaultOutPort__;
