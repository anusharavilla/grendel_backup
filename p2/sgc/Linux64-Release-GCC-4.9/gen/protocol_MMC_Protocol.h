...
#line 20 "/afs/eos/dist/ds-5_v5.24.1/FastModelsPortfolio_10.0/LISA/MMC_Protocol.lisa"
    ...
    // 4-bit field in status, codes 12-15 reserved.  See table 37, JES 84-A441 p. 98
    typedef enum {
        MMCS_IDLE       = 0,
        MMCS_READY      = 1,
        MMCS_ID         = 2,
...
#line 196 "./Linux64-Release-GCC-4.9/gen/protocol_MMC_Protocol.h"
