...
/** \file
 * Class definition for protocol Cortex__PVBusSlaveControl.
 */

#ifndef Cortex__PVBusSlaveControl_ClassDef_h_
#define Cortex__PVBusSlaveControl_ClassDef_h_
...
class Cortex__PVBusSlaveControl;
...
public:
    ...
    void SetPort(Cortex__PVBusSlaveControl *port) { thisPort = port; }
...
private:
    ...
    Cortex__PVBusSlaveControl *thisPort;
};


// Protocol (port) class definition
class Cortex__PVBusSlaveControl: public sg::Port
{
private:
...
provideReadStorage.bind_default_behaviour( this, &Cortex__PVBusSlaveControl::default_provideReadStorage);provideWriteStorage.bind_default_behaviour( this, &Cortex__PVBusSlaveControl::default_provideWriteStorage);provideReadWriteStorage.bind_default_behaviour( this, &Cortex__PVBusSlaveControl::default_provideReadWriteStorage);
    }
...
// Mapping object
// (these ports are implemented inside Cortex__PVBusSlaveControl__AddressablePort)
class Cortex__PVBusSlaveControl__AddressablePort_OutPort: public Cortex__PVBusSlaveControl
{
public:
    // constructor
    Cortex__PVBusSlaveControl__AddressablePort_OutPort(uint32_t inFirst,
                                                 uint32_t inLast,
                                                 uint32_t outFirst,
                                                 uint32_t outLast):
    inFirst__(inFirst),
...
class Cortex__PVBusSlaveControl__AddressablePort: public Cortex__PVBusSlaveControl
{
public:
    ...
    Cortex__PVBusSlaveControl__AddressablePort():
    defaultOutPort__(0),
    portName__("(unknown name)")
    {
        ...
        bind_method(*this, mapRange, &Cortex__PVBusSlaveControl__AddressablePort::mapRange__, this);
        bind_method(*this, mapDefault, &Cortex__PVBusSlaveControl__AddressablePort::mapDefault__, this);
        bind_method(*this, unmapRange, &Cortex__PVBusSlaveControl__AddressablePort::unmapRange__, this);
        bind_method(*this, isMapped, &Cortex__PVBusSlaveControl__AddressablePort::isMapped__, this);
    ...
    Cortex__PVBusSlaveControl__AddressablePort_OutPort *locateOutPort__(uint32_t &addr)
    {
        OutPortList__::iterator it;
        for (it = outPortList__.begin(); it != outPortList__.end(); ++it)
        {
    ...
    {
        Cortex__PVBusSlaveControl__AddressablePort_OutPort *masterPort =
            new Cortex__PVBusSlaveControl__AddressablePort_OutPort(inFirst, inLast, outFirst, outLast);
    ...
    {
        delete defaultOutPort__;
        defaultOutPort__ = new Cortex__PVBusSlaveControl__AddressablePort_OutPort(0, uint32_t(0) - 1, 0, uint32_t(0) - 1);
        return defaultOutPort__;
    }

    void unmapRange__(sg::Port* port)
    {
        outPortList__.remove((Cortex__PVBusSlaveControl__AddressablePort_OutPort*)port);
...
private:
    typedef std::list<Cortex__PVBusSlaveControl__AddressablePort_OutPort*> OutPortList__;
    OutPortList__ outPortList__;
    Cortex__PVBusSlaveControl__AddressablePort_OutPort *defaultOutPort__;
